            ...
            <div class="footer-column">
                ...
                <ul class="footer-contact-info">
                    <li>
                        ...
                        <span>Dekat Kodim Cimahi, Jl. Gatot Subroto No.36, Karangmekar, Kec. Cimahi Tengah, Kota Cimahi, Jawa Barat 40523</span>
                    </li>
                    <li>
                        <i class="fas fa-phone"></i>
                        <a href="tel:+6281234567890">+62 812-1276-1676</a>
                    </li>
                    <li>
